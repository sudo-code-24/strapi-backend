...
export interface ApiAnnouncementCategoryAnnouncementCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'announcement_categories';
  info: {
    displayName: 'Announcement Category';
    pluralName: 'announcement-categories';
    singularName: 'announcement-category';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::announcement-category.announcement-category'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiBoardSectionBoardSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'board_sections';
  info: {
    displayName: 'Board Section';
    pluralName: 'board-sections';
    singularName: 'board-section';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facultyMembers: Schema.Attribute.Relation<
      'oneToMany',
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::board-section.board-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFacultyMemberFacultyMember
  ...
  attributes: {
    boardSection: Schema.Attribute.Relation<
      'manyToOne',
      'api::board-section.board-section'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiGradeLevelGradeLevel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    boardSections: Schema.Attribute.Relation<
      'oneToMany',
      'api::board-section.board-section'
    >;
    createdAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::announcement-category.announcement-category': ApiAnnouncementCategoryAnnouncementCategory;
      'api::announcement.announcement': ApiAnnouncementAnnouncement;
      'api::board-section.board-section': ApiBoardSectionBoardSection;
